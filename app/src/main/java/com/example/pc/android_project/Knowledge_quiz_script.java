...
public class Knowledge_quiz_script extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.knowledge_quiz_script);
        ...
        cursor = db.rawQuery("SELECT question, answer, _id  FROM scriptTB order by random()", null);
        ...
        cursor = db.rawQuery("SELECT answer FROM scriptTB order by random()", null);
        while (cursor.moveToNext()) {
    ...
    void in() {
        if (sum == 5) {
            Intent intent = new Intent(Knowledge_quiz_script.this, Knowledge_quiz_end_script.class);
